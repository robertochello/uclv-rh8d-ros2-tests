...
class TestReadMotorsPositions : public rclcpp::Node
{
public:
    ...
    TestReadMotorsPositions()
    : Node("test_read_motors_positions_node")
    {
...
int main(int argc, char * argv[])
{
    ...
    try {
        auto hand_driver_node = std::make_shared<TestReadMotorsPositions>();
